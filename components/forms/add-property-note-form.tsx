...
import { addPropertyNoteAction } from "@/lib/ui/actions";
import { inputClass } from "@/components/forms/field";

export function AddPropertyNoteForm({
  propertyRef,
  revalidatePaths,
}: {
  propertyRef: string;
  ...
  const action = addPropertyNoteAction.bind(null, propertyRef, revalidatePaths);
